        ...
        {scenarios.map((scenario) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2.5 rounded-xl px-4.5 py-3 text-sm font-bold transition-all cursor-pointer ${
                isActive
            ...
            >
              ...
              <span
                className={`ml-1.5 rounded-md px-2 py-0.5 text-[10.5px] font-extrabold tracking-wide uppercase ${
                  isActive
                    ? scenario.tone === "gain"
      ...
      <div className="mt-8 grid items-stretch gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between rounded-2xl border border-rule bg-wash/70 p-6 sm:p-8">
          ...
          <div className="mt-8 pt-6 border-t border-rule grid grid-cols-3 gap-3 text-center">
            <div className="p-2">
              <div className="text-xl sm:text-2xl font-black text-ink">50+</div>
